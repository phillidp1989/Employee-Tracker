...
class Add {
  ...
  async addEmployee(firstName, lastName, roleId, managerId) {
    try {
        const newEmployee = await queryAsync(`INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES ('${firstName}', '${lastName}', '${roleId}', '${managerId}')`);
        console.log(`You have successfully added ${firstName} ${lastName} to the list of employees`);
  ...
  async addRole(title, salary, departmentId) {
    try {
        const newRole = await queryAsync(`INSERT INTO role (title, salary, department_id) VALUES ('${title}', '${salary}', '${departmentId}')`);
        console.log(`You have successfully added '${title}' to the list of roles`);      
  ...
  async addDepartment(name) {
    try {
        const newDepartment = await queryAsync(`INSERT INTO department (name) VALUES ('${name}')`);
        console.log(`You have successfully added '${name}' to the list of departments`);      
